...
export default function () {
  ...
  function getWeather(position) {
    ...
    let baseURL = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&lang=${lang}&appid=${API_KEY}&exclude=hourly,daily&units=metric`;
    ...
    https: $.get(baseURL, function (res) {
      ...
      let feels_like = Math.floor(res.main.feels_like);
